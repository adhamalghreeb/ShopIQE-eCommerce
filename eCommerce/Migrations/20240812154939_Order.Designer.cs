...
namespace eCommerce.Migrations
{
    ...
    [Migration("20240812154939_Order")]
    partial class Order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eCommerce.Core.entities.Order.Order", b =>
                {
                    ...
                    b.OwnsOne("eCommerce.Core.entities.Order.OrderAddress", "ShipToAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("eCommerce.Core.entities.Order.PaymentSummary", "PaymentSummary", b1 =>
                        {
                            b1.Property<int>("OrderId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerce.Core.entities.Order.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("eCommerce.Core.entities.Order.ProductItemOrdered", "ItemOrdered", b1 =>
                        {
